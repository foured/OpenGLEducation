...
Scene::Scene(int glfwVersionMajor, int glfwVersionMinor,
    ...
    //fbo
    defaultFBO = FramebufferObject(scrWidth, scrHeight, GL_DEPTH_BUFFER_BIT | GL_COLOR_BUFFER_BIT | GL_STENCIL_BUFFER_BIT);
...
bool Scene::init() {
    ...
    */
    ...
    // insert font
    fonts.insert("courer", TextRenderer(20));
    if (!fonts["courer"].loadFont(ft, "assets/fonts/courer.ttf")) {
